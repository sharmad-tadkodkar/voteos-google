...
const App: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-brand-900 text-slate-900 flex justify-center">
            {/* Mobile-first container */}
            <div className="w-full max-w-md bg-brand-900 flex flex-col h-screen relative shadow-2xl shadow-slate-300 border-x border-brand-700">
                
                {/* Top Bar */}
                <header className="bg-brand-900/80 backdrop-blur-md border-b border-brand-700 p-4 sticky top-0 z-20 flex justify-between items-center">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="font-extrabold tracking-tight text-lg text-slate-900">VOTE OS</span>
                    </div>
                    <div className="flex items-center gap-3">
                        ...
                        <button 
                            ...
                            className="p-2 text-slate-500 hover:text-slate-900 hover:bg-brand-700 rounded-full transition-colors"
                            title="Sign Out"
                        >
        ...
        <button 
            ...
            className={`flex flex-col items-center justify-center w-14 h-14 rounded-xl transition-all duration-200 ${
                isActive 
                    ...
                    : 'text-slate-500 hover:text-slate-700 hover:bg-brand-700/50'
            }`}
        >
